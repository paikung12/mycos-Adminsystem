...
Validator_1.default.defineLocale('ja', {
    defaultMessage: '{{field}}が正しくありません。',
    after: function (field, _, params) { return (field + "\u306F" + dateToString(params.date) + "\u3088\u308A\u5F8C\u306E\u65E5\u4ED8\u3092\u6307\u5B9A\u3057\u3066\u304F\u3060\u3055\u3044\u3002."); },
    ...
    before: function (field, _, params) { return (field + "\u306F" + dateToString(params.date) + "\u3088\u308A\u524D\u306E\u65E5\u4ED8\u3092\u6307\u5B9A\u3057\u3066\u304F\u3060\u3055\u3044\u3002."); },
    between: {
