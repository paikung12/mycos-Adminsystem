 ...
 * ```
 */
function moveTreeViewItem(sourceItemHierarchicalIndex, sourceData, operation, targetItemHierarchicalIndex, targetData) {
    if (!validateInput()) {
        return prepareInputDataForReturn();
    }
    var sourceItem = itemIdUtils_1.getItemById(sourceItemHierarchicalIndex, sourceData);
    if (!sourceItem) {
        return prepareInputDataForReturn();
    }
    ...
    if (!targetData || targetData === sourceData) {
        ...
        var updatedSourceData = itemUtils_1.removeItem(sourceItemHierarchicalIndex, sourceData);
        var resultData = itemUtils_1.addItem(sourceItem, operation, itemIdUtils_1.getDecrementedItemIdAfterRemoval(sourceItemHierarchicalIndex, targetItemHierarchicalIndex), updatedSourceData);
        ...
        var updatedSource = itemUtils_1.removeItem(sourceItemHierarchicalIndex, sourceData);
        var updatedTarget = itemUtils_1.addItem(sourceItem, operation, targetItemHierarchicalIndex, targetData);
    ...
    function validateInput() {
        ...
        if (!itemIdUtils_1.getItemById(targetItemHierarchicalIndex, data)) {
            return false;
        }
        return true;
    }
...
//# sourceMappingURL=moveTreeViewItem.js.map