...
var TreeView = /** @class */ (function (_super) {
    ...
    function TreeView(props) {
        ...
        _this.onBlur = function () {
            clearTimeout(_this.blurRequest);
            _this.blurRequest = setTimeout(function () { return _this.setFocus(undefined); }, 0);
        };
        ...
        if (this.fieldsSvc.focusIdField) {
            ...
            if (focusedItemPublicId) {
                var focusedItemId = this.props.getFocusHierarchicalIndex ?
                    ...
                    itemUtils_1.resolveItemId(focusedItemPublicId, this.fieldsSvc.focusIdField, this.data);
     ...
     * @hidden
     */
    TreeView.defaultProps = { animate: true };
    return TreeView;
}(React.Component));
