 ...
 * ```
 */
function handleTreeViewCheckChange(event, check, data, settings) {
...
function checkChildren(item, itemHierarchicalIndex, itemJustChecked, idField, ids) {
    itemUtils_1.getAllDirectIndirectChildrenIds(item, itemHierarchicalIndex, idField).forEach(function (itemId) {
...
function checkParents(itemHierarchicalIndex, itemJustChecked, idField, ids, data) {
    ...
    function check() {
        ...
        while (!result.done) {
            ...
            if (ids.indexOf(id) === -1 &&
                itemUtils_1.areAllDirectChildrenChecked(item, id, idField, ids)) {
                ids.push(id);
                result = it.next();
            }
            else {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    parents = itemUtils_1.getAllParents(itemHierarchicalIndex, data);
                    i = parents.length - 1;
                    _a.label = 1;
                case 1:
                ...
                case 6:
                    ...
                    return [4 /*yield*/, { id: parentId, item: itemJustChecked ? itemIdUtils_1.getItemById(parentId, data) : undefined }];
                case 7:
                    _a.sent();
...
//# sourceMappingURL=handleTreeViewCheckChange.js.map